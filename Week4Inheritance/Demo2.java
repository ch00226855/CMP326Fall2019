...
//		p1.setBloodType('A');
		...
		Person julius = new Person();
		julius.setName("Julius Randle");
		julius.setHeight(205.7);
		
		System.out.println("------------------------------------------------");
		team1.addPlayer(julius);
		System.out.println("Number of players after Julius joining the team: " + team1.getNumPlayers());
		
		Person marcus = new Person();
		marcus.setName("Marcus Morris");
		marcus.setHeight(205.7);
		team1.addPlayer(marcus);
		System.out.println("Number of players after Marcus joining the team: " + team1.getNumPlayers());
		
		Person bobby = new Person();
		bobby.setName("Bobby Portis");
		bobby.setHeight(210.82);
		team1.addPlayer(bobby);
		System.out.println("Number of players after Bobby joining the team: " + team1.getNumPlayers());
		
		System.out.println("The average height of the team: " + team1.getAverageHeight());
